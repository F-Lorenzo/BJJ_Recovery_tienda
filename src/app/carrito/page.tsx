...
export default function CartPage() {
  const { items, removeItem, updateQuantity, applyCoupon, cartLoading, applyingCoupon } = useCart();
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center justify-between mt-4 flex-wrap gap-3">
                            ...
                            <div className="flex items-center border border-sage/25 rounded-lg overflow-hidden bg-sand">
                              <button
                                onClick={() => item.quantity > 1 ? updateQuantity(item.key, item.quantity - 1) : removeItem(item.key)}
                                className="w-9 h-9 flex items-center justify-center text-ink hover:bg-sage/15 transition-colors text-sm font-semibold"
                                aria-label="Reducir"
                              >-</button>
                            ...
                            <div className="flex items-center gap-4">
                              ...
                              <button
                                ...
                                className="text-muted hover:text-alert transition-colors duration-200 p-1"
